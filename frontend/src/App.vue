    ...
    <main>
      ...
      <div class="relative overflow-hidden">
        ...
        <div aria-hidden="true" class="absolute inset-0">
          ...
          <div class="absolute inset-0 bg-linear-to-t from-white via-white" />
        </div>
        ...
        <section aria-labelledby="testimonial-heading" class="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          <div class="mx-auto max-w-2xl lg:max-w-none">
            ...
            <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:space-y-0 lg:gap-x-8">
              <blockquote v-for="testimonial in testimonials" :key="testimonial.id" class="sm:flex lg:block">
                ...
                <div class="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                  ...
                  <cite class="mt-4 block font-semibold text-gray-900 not-italic">{{ testimonial.attribution }}</cite>
                </div>
              </blockquote>
            </div>
          </div>
            ...
            <div class="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
              ...
              <div class="relative mx-auto max-w-sm text-center">
                ...
                <p class="mt-2 text-gray-200">
                  Did you sign up to the newsletter? If so, use the keyword we sent you to get access. <a href="#" class="font-bold whitespace-nowrap text-white hover:text-gray-200">Go now<span aria-hidden="true"> &rarr;</span></a>
                </p>
              </div>
            </div>
          </div>
